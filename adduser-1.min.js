var e=false,f='<img src="templates/exclamation.gif" border="0" />',g="";function h(a){if(a){a=window.event?event.keyCode:a.keyCode;if(a==9||a>=16&&a<=20||a>=33&&a<=40)return}a=document.getElementById("login");var b=document.getElementById("login_img");if(a.value==""){b.innerHTML=f;i(a);return e}b.innerHTML=g;j(a);return true}window.validateLogin=h;
...
window.passwordChanged=function(){var a=RegExp("^(?=.{8,})(?=.*[A-Z])(?=.*[a-z])(?=.*[0-9])(?=.*\\W).*$","g"),b=RegExp("^(?=.{7,})(((?=.*[A-Z])(?=.*[a-z]))|((?=.*[A-Z])(?=.*[0-9]))|((?=.*[a-z])(?=.*[0-9]))).*$","g"),d=RegExp("(?=.{5,}).*","g"),c=document.getElementById("haslo1");document.getElementById("strength").innerHTML=c.value.length==0?"":e==d.test(c.value)?"":a.test(c.value)?' <img src="templates/key.png" alt="key"/>  <img src="templates/key.png" alt="key"/>  <img src="templates/key.png" alt="key"/> <span style="color:green">Strong!</span>':
b.test(c.value)?' <img src="templates/key.png" alt="key"/>  <img src="templates/key.png" alt="key"/> <span style="color:orange">Medium!</span>':' <img src="templates/key.png" alt="key"/> <span style="color:red">Weak!</span>'};