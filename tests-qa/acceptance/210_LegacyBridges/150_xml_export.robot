...
ModifiedSince Has Limit
    Go To Url                             url=${GK_URL}/export.php?modifiedsince=20200311210000    redirect=${NO_REDIRECT_CHECK}
    Location Should Be                    ${PAGE_LEGACY_API_EXPORT_URL}?modifiedsince=20200311210000&${DEFAULT_PARAMS}
...
ModifiedSince Is Limited To Last 10 Days
    ...
    Location Should Be                    ${PAGE_LEGACY_API_EXPORT_URL}?modifiedsince=${date_10_days_old}&${DEFAULT_PARAMS}
    Page Should Not Contain               The requested period exceeds the 10 days limit
    Go To Url                             url=${GK_URL}/export.php?modifiedsince=${date_11_days_old}    redirect=${NO_REDIRECT_CHECK}
    Location Should Be                    ${PAGE_LEGACY_API_EXPORT_URL}?modifiedsince=${date_11_days_old}&${DEFAULT_PARAMS}
    Page Should Contain                   The requested period exceeds the 10 days limit

ModifiedSince Is In The Future
    Go To Url                             url=${GK_URL}/export.php?modifiedsince=22220311210000    redirect=${NO_REDIRECT_CHECK}
    Location Should Be                    ${PAGE_LEGACY_API_EXPORT_URL}?modifiedsince=22220311210000&${DEFAULT_PARAMS}
...
Validate XML - structure
    ...
    ${userid} =    Convert To String    ${USER_1.id}
    XML.Element Attribute Should Be       ${owner}                    id              ${userid}
    ...
    XML.Element Attribute Should Be       ${geokret}                  id             ${gkid}
    ...
    ${userid} =    Convert To String    ${USER_1.id}
    XML.Element Attribute Should Be       ${user}                     id                 ${userid}
    ...
    XML.Element Attribute Should Be       ${logtype}                  id                 ${move_type}
