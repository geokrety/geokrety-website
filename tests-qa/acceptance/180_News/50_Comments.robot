...
Access Comment By Unknow Id
    Sign In ${USER_1.name} Fast
    Go To Url                                       ${PAGE_NEWS_URL}/delete         newsid=123456    redirect=${PAGE_HOME_URL_EN}

Access Comment By Not An Id
    Sign In ${USER_1.name} Fast
    Go To Url                                       ${PAGE_NEWS_URL}/delete         newsid=FOOBAR    redirect=${PAGE_HOME_URL_EN}
