...
With param - secid+inventory
    Go To Url                            url=${GK_URL}/export2.php?secid=1324657890acbdefghijklmnopqrstuvwxz&inventory=1
