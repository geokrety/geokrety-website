<div class="panel panel-default">
  ...
  <div class="panel-body">
    ...
    <p>
      {t escape=no user=$user->username count=$statsCreatedGeokrety.count distance=$statsCreatedGeokrety.distance}
    ...
    <p>
      {t escape=no user=$user->username count=$statsMovedGeokrety.count distance=$statsMovedGeokrety.distance}
