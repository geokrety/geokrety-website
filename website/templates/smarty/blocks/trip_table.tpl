...
{if isset($tripTotal)}
{call pagination total=$tripTotal perpage=$tripPerPage anchor='watched'}
{/if}
<div class="table-responsive">
  <table class="table table-striped">
    <thead>
      <tr>
        <th></th>
        <th>{t}ID{/t}{if isset($tripTotal)} {sort column='id' type='numeric' anchor='owned'}{/if}</th>
        <th>{t}Spotted in{/t}{if isset($tripTotal)} {sort column='waypoint' type='alpha' anchor='owned'}{/if}</th>
        <th>{t}Comment{/t}</th>
        <th class="text-center">{t}Last move{/t}{if isset($tripTotal)} {sort column='ru.data' type='amount' anchor='owned'}{/if}</th>
        <th class="text-right"><img src="{$imagesUrl}/log-icons/dist.gif" title="{t}Distance{/t}" />{if isset($tripTotal)} {sort column='droga' type='numeric' anchor='owned'}{/if}</th>
        <th></th>
      </tr>
    </thead>
    <tbody>
