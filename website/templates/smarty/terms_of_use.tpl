...
<ol class="breadcrumb">
    ...
    <li class="active">{t}Term of use{/t}</li>
</ol>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <p class="text-justify">
            {t}Content published by you on the site may not contain vulgar expressions, abusive, or illegal content.{/t}
        </p>
    </div>
</div>
