...
VALUES (12110, 12101, 12101, coords2position(52.22968, 21.01223), '2020-09-01 08:00:00+00', 0);
INSERT INTO gk_moves (id, geokret, author, position, moved_on_datetime, move_type)
VALUES (12111, 12101, 12101, coords2position(50.06143, 19.93658), '2020-09-01 09:00:00+00', 0);
INSERT INTO gk_moves (id, geokret, username, position, moved_on_datetime, move_type)
VALUES (12112, 12102, 'country-snapshot-anon', coords2position(52.52000, 13.40500), '2020-10-01 08:00:00+00', 0);
...
SELECT is(stats.fn_snapshot_gk_country_stats('[2020-09-01,2020-10-01)'::daterange), 2::bigint, 'GK country snapshot keeps exact full-source rows even when p_period is supplied');
...
SELECT is((SELECT COUNT(*)::bigint FROM stats.gk_countries_visited), 2::bigint, 'GK country snapshot remains exact for the current full-source fixture set');
