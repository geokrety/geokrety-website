...
SELECT lives_ok($$INSERT INTO "gk_moves" ("geokret", "author", "position", "moved_on_datetime", "move_type") VALUES (2, 2, '0101000020E6100000F6285C8FC2F51C405C8FC2F528DC4540', '2024-05-24 00:00:00+00', 0)$$);
SELECT lives_ok($$INSERT INTO "gk_geokrety" ("id", "name", "type", "created_on_datetime", "owner") VALUES (3, 'test', 0, '2024-05-24 00:00:00+00', 1)$$);
SELECT lives_ok($$INSERT INTO "gk_moves" ("geokret", "author", "position", "moved_on_datetime", "move_type") VALUES (3, 2, '0101000020E6100000F6285C8FC2F51C405C8FC2F528DC4540', '2024-05-24 00:00:00+00', 3)$$);
SELECT lives_ok($$INSERT INTO "gk_geokrety" ("id", "name", "type", "created_on_datetime", "owner") VALUES (4, 'test', 0, '2024-05-24 00:00:00+00', 1)$$);
SELECT lives_ok($$INSERT INTO "gk_moves" ("geokret", "author", "moved_on_datetime", "move_type") VALUES (4, 2, '2024-05-24 00:00:03+00', 1)$$);
SELECT lives_ok($$INSERT INTO "gk_geokrety" ("id", "name", "type", "created_on_datetime", "owner") VALUES (5, 'test', 0, '2024-05-24 00:00:00+00', 1)$$);
SELECT lives_ok($$INSERT INTO "gk_moves" ("geokret", "author", "moved_on_datetime", "move_type") VALUES (5, 2, '2024-05-24 00:00:04+00', 2)$$);
-- Archive is only for owner
-- SELECT lives_ok($$INSERT INTO "gk_moves" ("geokret", "author", "moved_on_datetime", "move_type") VALUES (2, 2, '2024-05-24 00:00:05+00', 4)$$);
SELECT lives_ok($$INSERT INTO "gk_geokrety" ("id", "name", "type", "created_on_datetime", "owner") VALUES (6, 'test', 0, '2024-05-24 00:00:00+00', 1)$$);
SELECT lives_ok($$INSERT INTO "gk_moves" ("geokret", "author", "position", "moved_on_datetime", "move_type") VALUES (6, 2, '0101000020E6100000F6285C8FC2F51C405C8FC2F528DC4540', '2024-05-24 00:00:00+00', 5)$$);
...
SELECT lives_ok($$INSERT INTO "gk_moves" ("geokret", "author", "position", "moved_on_datetime", "move_type") VALUES (7, 1, '0101000020E6100000F6285C8FC2F51C405C8FC2F528DC4540', '2024-05-24 00:00:00+00', 0)$$);
SELECT lives_ok($$INSERT INTO "gk_geokrety" ("id", "name", "type", "created_on_datetime", "owner") VALUES (8, 'test', 0, '2024-05-24 00:00:00+00', 1)$$);
SELECT lives_ok($$INSERT INTO "gk_moves" ("geokret", "author", "position", "moved_on_datetime", "move_type") VALUES (8, 1, '0101000020E6100000F6285C8FC2F51C405C8FC2F528DC4540', '2024-05-24 00:00:00+00', 3)$$);
SELECT lives_ok($$INSERT INTO "gk_geokrety" ("id", "name", "type", "created_on_datetime", "owner") VALUES (9, 'test', 0, '2024-05-24 00:00:00+00', 1)$$);
SELECT lives_ok($$INSERT INTO "gk_moves" ("geokret", "author", "moved_on_datetime", "move_type") VALUES (9, 1, '2024-05-24 00:00:03+00', 1)$$);
SELECT lives_ok($$INSERT INTO "gk_geokrety" ("id", "name", "type", "created_on_datetime", "owner") VALUES (10, 'test', 0, '2024-05-24 00:00:00+00', 1)$$);
SELECT lives_ok($$INSERT INTO "gk_moves" ("geokret", "author", "moved_on_datetime", "move_type") VALUES (10, 1, '2024-05-24 00:00:04+00', 2)$$);
SELECT lives_ok($$INSERT INTO "gk_geokrety" ("id", "name", "type", "created_on_datetime", "owner") VALUES (11, 'test', 0, '2024-05-24 00:00:00+00', 1)$$);
SELECT lives_ok($$INSERT INTO "gk_moves" ("geokret", "author", "moved_on_datetime", "move_type") VALUES (11, 1, '2024-05-24 00:00:05+00', 4)$$);
SELECT lives_ok($$INSERT INTO "gk_geokrety" ("id", "name", "type", "created_on_datetime", "owner") VALUES (12, 'test', 0, '2024-05-24 00:00:00+00', 1)$$);
SELECT lives_ok($$INSERT INTO "gk_moves" ("geokret", "author", "position", "moved_on_datetime", "move_type") VALUES (12, 1, '0101000020E6100000F6285C8FC2F51C405C8FC2F528DC4540', '2024-05-24 00:00:00+00', 5)$$);
...
SELECT throws_ok($$INSERT INTO "gk_moves" ("geokret", "author", "position", "moved_on_datetime", "move_type") VALUES (14, 2, '0101000020E6100000F6285C8FC2F51C405C8FC2F528DC4540', '2024-05-24 00:00:03+00', 0)$$);
SELECT is(holder, 1::bigint) FROM "gk_geokrety" WHERE id = 14::bigint;
...
SELECT lives_ok($$INSERT INTO "gk_moves" ("geokret", "author", "position", "moved_on_datetime", "move_type") VALUES (15, 2, '0101000020E6100000F6285C8FC2F51C405C8FC2F528DC4540', '2024-05-24 00:00:03+00', 3)$$);
SELECT is(holder, 1::bigint) FROM "gk_geokrety" WHERE id = 15::bigint;
...
SELECT throws_ok($$INSERT INTO "gk_moves" ("geokret", "author", "moved_on_datetime", "move_type") VALUES (16, 2, '2024-05-24 00:00:03+00', 1)$$);
SELECT is(holder, 1::bigint) FROM "gk_geokrety" WHERE id = 16::bigint;
...
SELECT lives_ok($$INSERT INTO "gk_moves" ("geokret", "author", "moved_on_datetime", "move_type") VALUES (17, 2, '2024-05-24 00:00:03+00', 2)$$);
SELECT is(holder, 1::bigint) FROM "gk_geokrety" WHERE id = 17::bigint;
...
SELECT throws_ok($$INSERT INTO "gk_moves" ("geokret", "author", "position", "moved_on_datetime", "move_type") VALUES (18, 2, '0101000020E6100000F6285C8FC2F51C405C8FC2F528DC4540', '2024-05-24 00:00:03+00', 5)$$);
SELECT is(holder, 1::bigint) FROM "gk_geokrety" WHERE id = 18::bigint;
...
INSERT INTO "gk_moves" ("geokret", "author", "moved_on_datetime", "move_type") VALUES (30, 3, '2024-05-24 00:00:01+00', 1);
...
SELECT throws_ok($$INSERT INTO "gk_moves" ("geokret", "author", "position", "moved_on_datetime", "move_type") VALUES (30, 3, '0101000020E6100000F6285C8FC2F51C405C8FC2F528DC4540', '2024-05-24 00:00:03+00', 0)$$);
SELECT is(holder, 3::bigint) FROM "gk_geokrety" WHERE id = 30::bigint;
SELECT isnt(non_collectible, NULL) FROM "gk_geokrety" WHERE id = 30::bigint;

SELECT lives_ok($$INSERT INTO "gk_geokrety" ("id", "name", "type", "created_on_datetime", "owner") VALUES (31, 'test', 0, '2024-05-24 00:00:00+00', 1)$$);
INSERT INTO "gk_moves" ("geokret", "author", "moved_on_datetime", "move_type") VALUES (31, 3, '2024-05-24 00:00:01+00', 1);
...
SELECT throws_ok($$INSERT INTO "gk_moves" ("geokret", "author", "position", "moved_on_datetime", "move_type") VALUES (31, 3, '0101000020E6100000F6285C8FC2F51C405C8FC2F528DC4540', '2024-05-24 00:00:03+00', 3)$$);
...
INSERT INTO "gk_moves" ("geokret", "author", "moved_on_datetime", "move_type") VALUES (32, 3, '2024-05-24 00:00:01+00', 1);
...
SELECT throws_ok($$INSERT INTO "gk_moves" ("geokret", "author", "moved_on_datetime", "move_type") VALUES (32, 3, '2024-05-24 00:00:03+00', 1)$$);
...
INSERT INTO "gk_moves" ("geokret", "author", "moved_on_datetime", "move_type") VALUES (33, 3, '2024-05-24 00:00:01+00', 1);
...
SELECT lives_ok($$INSERT INTO "gk_moves" ("geokret", "author", "moved_on_datetime", "move_type") VALUES (12, 3, '2024-05-24 00:00:03+00', 2)$$);
SELECT isnt(non_collectible, NULL) FROM "gk_geokrety" WHERE id = 33::bigint;
SELECT is(holder, 3::bigint) FROM "gk_geokrety" WHERE id = 33::bigint;
...
INSERT INTO "gk_moves" ("geokret", "author", "moved_on_datetime", "move_type") VALUES (34, 3, '2024-05-24 00:00:01+00', 1);
...
SELECT lives_ok($$INSERT INTO "gk_moves" ("geokret", "author", "position", "moved_on_datetime", "move_type") VALUES (34, 3, '0101000020E6100000F6285C8FC2F51C405C8FC2F528DC4540', '2024-05-24 00:00:03+00', 5)$$);
SELECT isnt(non_collectible, NULL) FROM "gk_geokrety" WHERE id = 34::bigint;
SELECT is(holder, 3::bigint) FROM "gk_geokrety" WHERE id = 34::bigint;
...
INSERT INTO "gk_moves" ("geokret", "author", "moved_on_datetime", "move_type") VALUES (35, 3, '2024-05-24 00:00:01+00', 1);
...
SELECT throws_ok($$INSERT INTO "gk_moves" ("geokret", "author", "position", "moved_on_datetime", "move_type") VALUES (35, 1, '0101000020E6100000F6285C8FC2F51C405C8FC2F528DC4540', '2024-05-24 00:00:03+00', 0)$$);
SELECT isnt(non_collectible, NULL) FROM "gk_geokrety" WHERE id = 35::bigint;
SELECT is(holder, 3::bigint) FROM "gk_geokrety" WHERE id = 35::bigint;

SELECT lives_ok($$INSERT INTO "gk_geokrety" ("id", "name", "type", "created_on_datetime", "owner") VALUES (36, 'test', 0, '2024-05-24 00:00:00+00', 1)$$);
INSERT INTO "gk_moves" ("geokret", "author", "moved_on_datetime", "move_type") VALUES (36, 3, '2024-05-24 00:00:01+00', 1);
...
SELECT lives_ok($$INSERT INTO "gk_moves" ("geokret", "author", "position", "moved_on_datetime", "move_type") VALUES (36, 1, '0101000020E6100000F6285C8FC2F51C405C8FC2F528DC4540', '2024-05-24 00:00:03+00', 3)$$);
SELECT isnt(non_collectible, NULL) FROM "gk_geokrety" WHERE id = 36::bigint;
SELECT is(holder, 3::bigint) FROM "gk_geokrety" WHERE id = 36::bigint;

SELECT lives_ok($$INSERT INTO "gk_geokrety" ("id", "name", "type", "created_on_datetime", "owner") VALUES (37, 'test', 0, '2024-05-24 00:00:00+00', 1)$$);
INSERT INTO "gk_moves" ("geokret", "author", "moved_on_datetime", "move_type") VALUES (37, 3, '2024-05-24 00:00:01+00', 1);
...
SELECT throws_ok($$INSERT INTO "gk_moves" ("geokret", "author", "moved_on_datetime", "move_type") VALUES (37, 1, '2024-05-24 00:01:03+00', 1)$$);
SELECT isnt(non_collectible, NULL) FROM "gk_geokrety" WHERE id = 37::bigint;
SELECT is(holder, 3::bigint) FROM "gk_geokrety" WHERE id = 37::bigint;

SELECT lives_ok($$INSERT INTO "gk_geokrety" ("id", "name", "type", "created_on_datetime", "owner") VALUES (38, 'test', 0, '2024-05-24 00:00:00+00', 1)$$);
INSERT INTO "gk_moves" ("geokret", "author", "moved_on_datetime", "move_type") VALUES (38, 3, '2024-05-24 00:00:01+00', 1);
...
SELECT lives_ok($$INSERT INTO "gk_moves" ("geokret", "author", "moved_on_datetime", "move_type") VALUES (38, 1, '2024-05-24 00:00:03+00', 2)$$);
SELECT isnt(non_collectible, NULL) FROM "gk_geokrety" WHERE id = 38::bigint;
SELECT is(holder, 3::bigint) FROM "gk_geokrety" WHERE id = 38::bigint;

SELECT lives_ok($$INSERT INTO "gk_geokrety" ("id", "name", "type", "created_on_datetime", "owner") VALUES (39, 'test', 0, '2024-05-24 00:00:00+00', 1)$$);
INSERT INTO "gk_moves" ("geokret", "author", "moved_on_datetime", "move_type") VALUES (39, 3, '2024-05-24 00:00:01+00', 1);
...
SELECT lives_ok($$INSERT INTO "gk_moves" ("geokret", "author", "moved_on_datetime", "move_type") VALUES (39, 1, '2024-05-24 00:00:03+00', 4)$$);
SELECT isnt(non_collectible, NULL) FROM "gk_geokrety" WHERE id = 39::bigint;
...
INSERT INTO "gk_moves" ("geokret", "author", "moved_on_datetime", "move_type") VALUES (40, 3, '2024-05-24 00:00:01+00', 1);
...
SELECT throws_ok($$INSERT INTO "gk_moves" ("geokret", "author", "position", "moved_on_datetime", "move_type") VALUES (40, 1, '0101000020E6100000F6285C8FC2F51C405C8FC2F528DC4540', '2024-05-24 00:00:03+00', 5)$$);
SELECT isnt(non_collectible, NULL) FROM "gk_geokrety" WHERE id = 40::bigint;
SELECT is(holder, 3::bigint) FROM "gk_geokrety" WHERE id = 40::bigint;
...
-- 121
SELECT lives_ok($$INSERT INTO "gk_moves" ("geokret", "author", "position", "moved_on_datetime", "move_type") VALUES (41, 2, '0101000020E6100000F6285C8FC2F51C405C8FC2F528DC4540', '2024-05-24 00:00:01+00', 0)$$);
...
INSERT INTO "gk_moves" ("geokret", "author", "moved_on_datetime", "move_type") VALUES (42, 3, '2024-05-24 00:00:01+00', 1);
SELECT is(holder, 3::bigint) FROM "gk_geokrety" WHERE id = 42::bigint;
SELECT throws_ok($$INSERT INTO "gk_moves" ("geokret", "author", "position", "moved_on_datetime", "move_type") VALUES (42, 2, '0101000020E6100000F6285C8FC2F51C405C8FC2F528DC4540', '2024-05-24 00:00:02+00', 0)$$);
SELECT is(holder, 3::bigint) FROM "gk_geokrety" WHERE id = 42::bigint;
...
SELECT lives_ok($$INSERT INTO "gk_moves" ("geokret", "author", "position", "moved_on_datetime", "move_type") VALUES (43, 2, '0101000020E6100000F6285C8FC2F51C405C8FC2F528DC4540', '2024-05-24 00:00:02+00', 0)$$);
