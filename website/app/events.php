...
// $events->on('password.token.generated', function (\GeoKrety\Model\PasswordToken $passwordToken) {});
// $events->on('password.token.used', function (\GeoKrety\Model\PasswordToken $passwordToken) {});
