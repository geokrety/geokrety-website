...
class DatabaseReset extends Base {
    public const TABLES = [
        'gk_account_activation', 'audits.actions_logs', 'audits.posts', 'gk_awards_won', 'gk_email_activation',
    ...
    public const SEQUENCES = [
        ...
        'owner_codes_id_seq', 'password_tokens_id_seq', 'audits.posts_id_seq', 'pictures_id_seq',
        'races_id_seq', 'races_participants_id_seq', 'audits.audit_logs_id_seq',
