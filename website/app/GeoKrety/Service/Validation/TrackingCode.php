...
class TrackingCode {
    ...
    private function renderGeokret($geokret) {
        ...
        $response = array(
            ...
            'ownerName' => $geokret->owner->username,
            'holderId' => $geokret->holder->id,
            'holderName' => $geokret->holder->username,
            ...
            'lastPositionId' => $geokret->last_position->id,
            'lastLogId' => $geokret->last_log->id,
