...
class Config extends \Prefab {
    public function __construct() {
        ...
        define('GK_SITE_EMAIL_REVALIDATE_SEND_INTERVAL_MINUTES', getenv('GK_SITE_EMAIL_REVALIDATE_SEND_INTERVAL_MINUTES') ?: 10);
        ...
        define('GK_SITE_EMAIL_DAILY_MAIL', getenv('GK_SITE_EMAIL_DAILY_MAIL') ?: GK_SITE_EMAIL_NOREPLY);
        ...
        define('GK_UPTIMEROBOT_URL', getenv('GK_UPTIMEROBOT_URL') ?: 'https://status.geokrety.org');
        ...
        if (GK_IS_PRODUCTION) {
            ...
            define('GK_HELP_GEOKRETY_EXAMPLE_6', getenv('GK_HELP_GEOKRETY_EXAMPLE_6') ?: 106727);
            define('GK_HELP_GEOKRETY_EXAMPLE_7', getenv('GK_HELP_GEOKRETY_EXAMPLE_7') ?: 106753);
        } else {
            ...
            define('GK_HELP_GEOKRETY_EXAMPLE_5', getenv('GK_HELP_GEOKRETY_EXAMPLE_5') ?: GK_HELP_GEOKRETY_EXAMPLE_2);
            define('GK_HELP_GEOKRETY_EXAMPLE_6', getenv('GK_HELP_GEOKRETY_EXAMPLE_6') ?: GK_HELP_GEOKRETY_EXAMPLE_2);
            define('GK_HELP_GEOKRETY_EXAMPLE_7', getenv('GK_HELP_GEOKRETY_EXAMPLE_7') ?: GK_HELP_GEOKRETY_EXAMPLE_2);
        }
        ...
        define('GK_DB_PASSWORD', getsecret('GK_DB_PASSWORD') ?: 'geokrety');
        ...
        define('GK_SITE_CACHE_TTL_WAYPOINT_DETAIL', getenv('GK_SITE_CACHE_TTL_WAYPOINT_DETAIL') ?: (GK_DEVEL ? 0 : 1800));
        define('GK_SITE_CACHE_TTL_STATISTICS_COUNTRIES', getenv('GK_SITE_CACHE_TTL_STATISTICS_COUNTRIES') ?: (GK_DEVEL ? 0 : 3600));
        define('GK_SITE_CACHE_TTL_STATISTICS_REGISTRATIONS', getenv('GK_SITE_CACHE_TTL_STATISTICS_REGISTRATIONS') ?: (GK_DEVEL ? 0 : 1800));
        define('GK_SITE_CACHE_TTL_STATISTICS_COUNTRY_TRENDS', getenv('GK_SITE_CACHE_TTL_STATISTICS_COUNTRY_TRENDS') ?: (GK_DEVEL ? 0 : 86400)); // 24 hours
