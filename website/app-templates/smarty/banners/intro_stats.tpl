<div class="panel panel-default">
  ...
  <div class="panel-body">
    ...
    <p>
      🚀 {t escape=no
        gk_distance=$stats.stat_droga|default:0
      ...
      }<strong>%1</strong> km done by all GeoKrety (it is <strong>%2</strong> x distance from the Earth to the Moon 🌛, <strong>%3</strong> x the Earth equatorial circumference 🌍 and <strong>%4</strong> x the distance from the Earth to the Sun 🌞).{/t}
    </p>
    <p>
