...
{block name=content}
<p>{t escape=no gkname=$geokret->name|escape gkurl={'geokret_details'|alias:sprintf('@gkid=%s', $geokret->gkid)} username=$geokret->owner->username|escape userurl={'user_details'|alias:sprintf('@userid=%d', $geokret->owner->id)}}Good news, your GeoKret <a href="%2">%1</a> was just adopted by user <a href="%4">%3</a>.{/t}</p>
<div class="s-3"></div>
