...
{block name=content}
<p class="text-justify">{t escape=no count={$expiringTokens|sizeof} delay=GK_SITE_ACCOUNT_ACTIVATION_CODE_DAYS_VALIDITY}%1 account are still not activated after %2 days. They will now be deleted.{/t}</p>
    <ul>
