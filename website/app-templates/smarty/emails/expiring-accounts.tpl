...
{block name=content}
<p class="text-justify">{t escape=no count=$totalExpiringTokens delay=GK_SITE_ACCOUNT_ACTIVATION_CODE_DAYS_VALIDITY}%1 accounts are still not activated after %2 days. They will now be deleted.{/t}</p>
    <ul>
