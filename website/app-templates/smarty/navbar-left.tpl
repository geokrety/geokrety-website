...
<ul class="nav navbar-nav">
    <li class="dropdown">
        <a id="navbar-lang" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
            <img src="{GK_CDN_ICONS_URL}/language.svg" width="14" height="14" alt="Language selector" /><span class="visible-xs-inline" title="{t}Currently selected language{/t}"> {\Multilang::instance()->current|language:true}</span>
    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li><a id="navbar-privacy-statement" href="{'privacy_statement'|alias}">{fa icon="legal"} {t}Privacy statement{/t}</a></li>
