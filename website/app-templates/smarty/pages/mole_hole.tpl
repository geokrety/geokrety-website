...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <ol>
            <li>{t}The system is based on mole-to-mole (peer-to-peer) tunnels. A mole-hole-cache should have a single dedicated destination. A dedicated destination doesn't mean a special cache - an arriving GeoKrety may appear in any cache within the destination area.{/t}</li>
