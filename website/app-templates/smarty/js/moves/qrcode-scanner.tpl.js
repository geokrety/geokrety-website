...
//{literal}
    ...
    function initQrScannerModal() {
        ...
        // Bind finish button
        $('#qr-finish-button').on('click', function() {
            finishScanning();
        });
    }
    ...
    function initQrScannerButton() {
        ...
        // Show button only if camera is supported and likely a mobile device
        if (hasCameraSupport() && isMobileDevice()) {
            ...
            // Hide button on desktop or devices without camera support
            $qrButton.hide();
        }
    }
