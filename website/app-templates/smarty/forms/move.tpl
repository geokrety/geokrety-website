        ...
        <div id="panelMoveLogType" class="panel panel-default">
            ...
            <div id="collapseLogtype" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingLogtype">
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12" id="infoLogtypeNotCollectible" hidden>
                            <div class="alert alert-info" role="alert">
                                {t}This GeoKret is not collectible, so some move types are not available.{/t}
                            </div>
                        </div>
                    </div>
                    <div class="row">
